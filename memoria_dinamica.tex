...
Si ocurriera algún problema, porque el sistema no tuviera suficiente memoria
disponible o similar, la llamada de \lstinline!malloc! devolvería
\lstinline!NULL!.
...
necesario convertir el puntero genérico \lstinline!void *! devuelto por
